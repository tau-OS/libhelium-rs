...
extern "C" {
    ...
    pub fn he_bottom_bar_new(title: *const c_char, description: *const c_char) -> *mut HeBottomBar;
    ...
    pub fn he_mini_content_block_new(title: *const c_char, subtitle: *const c_char, primary_button: *mut HeButton) -> *mut HeMiniContentBlock;
