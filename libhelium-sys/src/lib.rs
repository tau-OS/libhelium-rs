...
extern "C" {
    ...
    pub fn he_bin_grab_focus(self_: *mut HeBin, widget: *mut gtk::GtkWidget) -> gboolean;
    pub fn he_bin_grab_focus_child(self_: *mut HeBin, widget: *mut gtk::GtkWidget) -> gboolean;
    ...
    pub fn he_content_block_image_cluster_add_child(self_: *mut HeContentBlockImageCluster, builder: *mut gtk::GtkBuilder, child: *mut gobject::GObject, type_: *const c_char);
