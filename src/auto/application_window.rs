...
impl<O: IsA<ApplicationWindow>> ApplicationWindowExt for O {
    ...
    fn connect_modal_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_modal_trampoline<P: IsA<ApplicationWindow>, F: Fn(&P) + 'static>(this: *mut ffi::HeApplicationWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
