...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ContentBlockImageExt`][trait@crate::prelude::ContentBlockImageExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    pub struct ContentBlockImage(Object<ffi::HeContentBlockImage, ffi::HeContentBlockImageClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl ContentBlockImageBuilder {
    ...
    pub fn build(self) -> ContentBlockImage {
        ...
        glib::Object::new::<ContentBlockImage>(&properties)
            .expect("Failed to create an instance of ContentBlockImage")
    }
...
/// Trait containing all [`struct@ContentBlockImage`] methods.
///
/// # Implementors
///
/// [`ContentBlockImage`][struct@crate::ContentBlockImage]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@ContentBlockImage`] methods.
///
/// # Implementors
