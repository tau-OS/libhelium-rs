...
if let Some(ref accessible_role) = self.accessible_role {
        ...
        glib::Object::new::<Badge>(&properties)
                .expect("Failed to create an instance of Badge")
...
impl<O: IsA<Badge>> BadgeExt for O {
    ...
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<Badge>, F: Fn(&P) + 'static>(this: *mut ffi::HeBadge, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
