...
impl Latch {
    ...
    pub fn new() -> Latch {
        unsafe { from_glib_none(ffi::he_latch_new()) }
    }
...
impl LatchBuilder {
    ...
    pub fn build(self) -> Latch {
        ...
        glib::Object::new::<Latch>(&properties).expect("Failed to create an instance of Latch")
    }
...
impl<O: IsA<Latch>> LatchExt for O {
    fn tightening_threshold(&self) -> i32 {
        unsafe { ffi::he_latch_get_tightening_threshold(self.as_ref().to_glib_none().0) }
    }
    ...
    fn maximum_size(&self) -> i32 {
        unsafe { ffi::he_latch_get_maximum_size(self.as_ref().to_glib_none().0) }
    }
    ...
    fn child(&self) -> Option<gtk::Widget> {
        unsafe { from_glib_none(ffi::he_latch_get_child(self.as_ref().to_glib_none().0)) }
    }

    fn set_child(&self, value: &impl IsA<gtk::Widget>) {
        unsafe {
            ffi::he_latch_set_child(
    ...
    fn connect_maximum_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_maximum_size_trampoline<P: IsA<Latch>, F: Fn(&P) + 'static>(
            this: *mut ffi::HeLatch,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<Latch>, F: Fn(&P) + 'static>(
            this: *mut ffi::HeLatch,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
