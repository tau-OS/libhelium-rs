...
use crate::Colors;
use crate::OverlayButtonAlignment;
use crate::OverlayButtonSize;
...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`OverlayButtonExt`][trait@crate::prelude::OverlayButtonExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    pub struct OverlayButton(Object<ffi::HeOverlayButton, ffi::HeOverlayButtonClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl Default for OverlayButton {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct OverlayButton object with default parameters")
    }
}
...
impl OverlayButtonBuilder {
    ...
    pub fn build(self) -> OverlayButton {
        ...
        glib::Object::new::<OverlayButton>(&properties)
            .expect("Failed to create an instance of OverlayButton")
    }
...
/// Trait containing all [`struct@OverlayButton`] methods.
///
/// # Implementors
///
/// [`OverlayButton`][struct@crate::OverlayButton]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@OverlayButton`] methods.
///
/// # Implementors
...
impl<O: IsA<OverlayButton>> OverlayButtonExt for O {
    ...
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(
            this: *mut ffi::HeOverlayButton,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
