...
impl<O: IsA<OverlayButton>> OverlayButtonExt for O {
    ...
    fn connect_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_trampoline<P: IsA<OverlayButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeOverlayButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(OverlayButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
