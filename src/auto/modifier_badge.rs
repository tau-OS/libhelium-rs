...
use crate::Colors;
use crate::ModifierBadgeAlignment;
...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ModifierBadgeExt`][trait@crate::prelude::ModifierBadgeExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    pub struct ModifierBadge(Object<ffi::HeModifierBadge, ffi::HeModifierBadgeClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl Default for ModifierBadge {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct ModifierBadge object with default parameters")
    }
}
...
impl ModifierBadgeBuilder {
    ...
    pub fn build(self) -> ModifierBadge {
        ...
        glib::Object::new::<ModifierBadge>(&properties)
            .expect("Failed to create an instance of ModifierBadge")
    }
...
/// Trait containing all [`struct@ModifierBadge`] methods.
///
/// # Implementors
///
/// [`ModifierBadge`][struct@crate::ModifierBadge]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@ModifierBadge`] methods.
///
/// # Implementors
