...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ContentListExt`][trait@crate::prelude::ContentListExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    pub struct ContentList(Object<ffi::HeContentList, ffi::HeContentListClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
/// Trait containing all [`struct@ContentList`] methods.
///
/// # Implementors
///
/// [`ContentList`][struct@crate::ContentList]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@ContentList`] methods.
///
/// # Implementors
