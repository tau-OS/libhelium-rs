...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ContentBlockExt`][trait@crate::prelude::ContentBlockExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    pub struct ContentBlock(Object<ffi::HeContentBlock, ffi::HeContentBlockClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl Default for ContentBlock {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct ContentBlock object with default parameters")
    }
}
...
impl ContentBlockBuilder {
    ...
    pub fn build(self) -> ContentBlock {
        ...
        glib::Object::new::<ContentBlock>(&properties)
            .expect("Failed to create an instance of ContentBlock")
    }
...
/// Trait containing all [`struct@ContentBlock`] methods.
///
/// # Implementors
///
/// [`ContentBlock`][struct@crate::ContentBlock]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@ContentBlock`] methods.
///
/// # Implementors
...
pub trait ContentBlockExt: 'static {
    ...
    fn secondary_button(&self) -> Option<Button>;
