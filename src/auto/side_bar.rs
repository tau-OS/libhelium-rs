...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`SideBarExt`][trait@crate::prelude::SideBarExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    /// [`SideBarExt`][trait@crate::prelude::SideBarExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    #[doc(alias = "HeSideBar")]
    pub struct SideBar(Object<ffi::HeSideBar, ffi::HeSideBarClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl Default for SideBar {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct SideBar object with default parameters")
    }
}
...
impl SideBarBuilder {
    ...
    pub fn build(self) -> SideBar {
        ...
        glib::Object::new::<SideBar>(&properties).expect("Failed to create an instance of SideBar")
    }
...
/// Trait containing all [`struct@SideBar`] methods.
///
/// # Implementors
///
/// [`SideBar`][struct@crate::SideBar]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@SideBar`] methods.
///
/// # Implementors
