...
/// Trait containing all [`struct@AboutWindow`] methods.
///
/// # Implementors
///
/// [`AboutWindow`][struct@crate::AboutWindow]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@AboutWindow`] methods.
///
/// # Implementors
    ...
    fn translator_names(&self) -> Vec<glib::GString> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_none_num(
                ...
                result_length1.assume_init() as usize,
            );
            ret
        }
    }
