...
impl MiniContentBlock {
    ...
    pub fn new(title: &str, subtitle: &str, primary_button: &impl IsA<Button>) -> MiniContentBlock {
        unsafe {
...
impl Default for MiniContentBlock {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct MiniContentBlock object with default parameters")
    }
}
