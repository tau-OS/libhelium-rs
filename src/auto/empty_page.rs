...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`EmptyPageExt`][trait@crate::prelude::EmptyPageExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    pub struct EmptyPage(Object<ffi::HeEmptyPage, ffi::HeEmptyPageClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl EmptyPageBuilder {
    ...
    pub fn build(self) -> EmptyPage {
        ...
        glib::Object::new::<EmptyPage>(&properties)
            .expect("Failed to create an instance of EmptyPage")
    }
...
/// Trait containing all [`struct@EmptyPage`] methods.
///
/// # Implementors
///
/// [`EmptyPage`][struct@crate::EmptyPage]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@EmptyPage`] methods.
///
/// # Implementors
...
pub trait EmptyPageExt: 'static {
    ...
    fn button(&self) -> Option<glib::GString>;
