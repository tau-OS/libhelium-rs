...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`BannerExt`][trait@crate::prelude::BannerExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    /// [`BannerExt`][trait@crate::prelude::BannerExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    #[doc(alias = "HeBanner")]
    pub struct Banner(Object<ffi::HeBanner, ffi::HeBannerClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
impl Default for Banner {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct Banner object with default parameters")
    }
}
...
impl BannerBuilder {
    ...
    pub fn build(self) -> Banner {
        ...
        glib::Object::new::<Banner>(&properties).expect("Failed to create an instance of Banner")
    }
...
/// Trait containing all [`struct@Banner`] methods.
///
/// # Implementors
///
/// [`Banner`][struct@crate::Banner]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@Banner`] methods.
///
/// # Implementors
