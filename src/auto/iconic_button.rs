...
impl<O: IsA<IconicButton>> IconicButtonExt for O {
    ...
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<IconicButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeIconicButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
