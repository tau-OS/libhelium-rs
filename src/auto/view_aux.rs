...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ViewAuxExt`][trait@crate::prelude::ViewAuxExt], [`ViewExt`][trait@crate::prelude::ViewExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
...
impl ViewAuxBuilder {
    ...
    pub fn build(self) -> ViewAux {
        ...
        glib::Object::new::<ViewAux>(&properties).expect("Failed to create an instance of ViewAux")
    }
...
/// Trait containing all [`struct@ViewAux`] methods.
///
/// # Implementors
///
/// [`ViewAux`][struct@crate::ViewAux]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@ViewAux`] methods.
///
/// # Implementors
