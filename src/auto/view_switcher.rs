...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ViewSwitcherExt`][trait@crate::prelude::ViewSwitcherExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    pub struct ViewSwitcher(Object<ffi::HeViewSwitcher, ffi::HeViewSwitcherClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
/// Trait containing all [`struct@ViewSwitcher`] methods.
///
/// # Implementors
///
/// [`ViewSwitcher`][struct@crate::ViewSwitcher]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@ViewSwitcher`] methods.
///
/// # Implementors
