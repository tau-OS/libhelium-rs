...
impl<O: IsA<DisclosureButton>> DisclosureButtonExt for O {
    fn connect_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_trampoline<P: IsA<DisclosureButton>, F: Fn(&P) + 'static>(this: *mut ffi::HeDisclosureButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
