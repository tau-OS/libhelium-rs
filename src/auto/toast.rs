...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ToastExt`][trait@crate::prelude::ToastExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    ...
    /// [`ToastExt`][trait@crate::prelude::ToastExt], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`]
    #[doc(alias = "HeToast")]
    pub struct Toast(Object<ffi::HeToast, ffi::HeToastClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
/// Trait containing all [`struct@Toast`] methods.
///
/// # Implementors
///
/// [`Toast`][struct@crate::Toast]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@Toast`] methods.
///
/// # Implementors
...
pub trait ToastExt: 'static {
    ...
    fn default_action(&self) -> Option<glib::GString>;
