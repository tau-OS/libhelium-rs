...
use crate::ContentBlockImage;
use crate::ContentBlockImageClusterImagePosition;
...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`ContentBlockImageClusterExt`][trait@crate::prelude::ContentBlockImageClusterExt], [`trait@gtk::prelude::BoxExt`], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`], [`trait@gtk::prelude::OrientableExt`]
    ...
    pub struct ContentBlockImageCluster(Object<ffi::HeContentBlockImageCluster, ffi::HeContentBlockImageClusterClass>) @extends gtk::Box, gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Orientable;
...
impl Default for ContentBlockImageCluster {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct ContentBlockImageCluster object with default parameters")
    }
}
...
impl ContentBlockImageClusterBuilder {
    ...
    pub fn build(self) -> ContentBlockImageCluster {
        ...
        glib::Object::new::<ContentBlockImageCluster>(&properties)
            .expect("Failed to create an instance of ContentBlockImageCluster")
    }
...
/// Trait containing all [`struct@ContentBlockImageCluster`] methods.
///
/// # Implementors
///
/// [`ContentBlockImageCluster`][struct@crate::ContentBlockImageCluster]
// rustdoc-stripper-ignore-next-stop
/// Trait containing all [`struct@ContentBlockImageCluster`] methods.
///
/// # Implementors
