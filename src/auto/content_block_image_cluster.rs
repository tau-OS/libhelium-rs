...
glib::wrapper! {
    ...
    pub struct ContentBlockImageCluster(Object<ffi::HeContentBlockImageCluster, ffi::HeContentBlockImageClusterClass>) @extends gtk::Widget, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
...
pub trait ContentBlockImageClusterExt: 'static {
    ...
    #[doc(alias = "he_content_block_image_cluster_add_child")]
    fn add_child(
        &self,
        builder: &gtk::Builder,
...
impl<O: IsA<ContentBlockImageCluster>> ContentBlockImageClusterExt for O {
    ...
    fn add_child(
        ...
        unsafe {
            ffi::he_content_block_image_cluster_add_child(
                self.as_ref().to_glib_none().0,
