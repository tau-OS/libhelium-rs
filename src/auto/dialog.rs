...
use crate::FillButton;
use crate::TintButton;
use crate::Window;
...
glib::wrapper! {
    ...
    /// # Implements
    ///
    /// [`DialogExt`][trait@crate::prelude::DialogExt], [`HeWindowExt`][trait@crate::prelude::HeWindowExt], [`trait@gtk::prelude::WindowExt`], [`trait@gtk::prelude::WidgetExt`], [`trait@glib::ObjectExt`], [`trait@gtk::prelude::AccessibleExt`], [`trait@gtk::prelude::BuildableExt`], [`trait@gtk::prelude::ConstraintTargetExt`], [`trait@gtk::prelude::NativeExt`], [`trait@gtk::prelude::RootExt`], [`trait@gtk::prelude::ShortcutManagerExt`]
...
impl Default for Dialog {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[])
            .expect("Can't construct Dialog object with default parameters")
    }
}
...
pub trait DialogExt: 'static {
    ...
    fn secondary_button(&self) -> Option<TintButton>;
    ...
    fn primary_button(&self) -> Option<FillButton>;
