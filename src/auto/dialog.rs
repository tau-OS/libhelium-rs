...
if let Some(ref accessible_role) = self.accessible_role {
        ...
        glib::Object::new::<Dialog>(&properties)
                .expect("Failed to create an instance of Dialog")
...
impl<O: IsA<Dialog>> DialogExt for O {
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<Dialog>, F: Fn(&P) + 'static>(this: *mut ffi::HeDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
